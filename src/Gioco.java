...
public class Gioco {
    ...
    private Sound jukeBox = new Sound();
    ...
    private void fight(Player p){
        ...
        gui.displayString("Fight!");
            ...
            if(playerTot > playerTot1){
                ...
                gui.displayWonPoints((int)(p.getPoints() / 2));
                ...
                gui.displayLostPoints((int)(currPlayer.getPoints() / 2));
    ...
    private void rollCommand() {
        if(!rollDone) {
            ...
            Tile tile = board.getTile(currPlayer.getPosition());
            tile.removePlayerPresence(currPlayer);
    ...
    private void pointsCommand(){
        for(Player p: players.get()){
            ...
            gui.displayString(p.getName() + "   " + p.getPoints() + " points");
        }   
    }
